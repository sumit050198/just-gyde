    ...
    return (
        ...
        <div className="footer">
                        ...
                        <div className="footerNav d-flex justify-content-center align-items-center">
                            ...
                            <div className="ContactsUs mx-5">
                                <ul className="navbarLink">
                                    ...
                                    <li className='my-4'> <Link className='d-flex' to="/"><img className='icon my-1 mx-2' src="./image/Email.png" alt="" /> contact@Justgyde.com </Link></li>
            ...
            <div className=" d-flex justify-content-center align-items-center">
                ...
                <li className='termAndCondi'> <Link className="copyrights mx-1" to="/">All Rights Reserved | </Link></li>
