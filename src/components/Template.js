...
const About = () => {
    return (
        <div className="container head1">
            ...
            <p className='parra1'>Welcome to Just Gyde, your all-in-one platform for essential services in healthcare, education, finance, and entertainment. Our mission is to empower communities by making these services easily accessible and user-friendly.
                ...
                We strive for a world where everyone has equal access to vital services, leading to healthier, more educated, financially stable, and enjoyable lives.</p>
        </div>
    )
}
    ...
    return (
        <div className="container head2">
            ...
            <div className="ourServicesimg">
                <img className='Rectangle2' src="./image/panting.jpg" alt="" />
                <div className="ourServices">
                    <h3 className='painting'> Educational Service</h3>
                    <p className='parra2'>At Just Gyde, we believe in the Right to Education for all, ensuring every student has access to quality education. We help students secure free education opportunities, breaking down financial barriers to learning. Our platform facilitates mediation between schools and colleges, helping students find the best academic institutions. We provide resources and support to navigate the education system effectively. Our services aim to create a more equitable education landscape. By connecting students with scholarships and financial aid, we empower them to reach their full potential. Just Gyde is dedicated to fostering educational growth and opportunities for all. Join us in making education accessible and achievable for every learner.
                    </p>
                </div>
            </div>
        </div>
